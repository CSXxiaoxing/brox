    ...
    <ul @click="open" v-show='showVar==0'>
        <li>
            ...
            <label :judge='"open"' @click='boxNo'>
                <span>
                    <img src="src/srcImg/oxCrowd012.png" v-show='initData.zn_room_type==1' height="81" width="76" alt="" />
                </span>
                公开
            </label>
        </li>
        ...
        <li>
            ...
            <label :judge='"cardFn5"'>
                <span>
                    <img src="src/srcImg/oxCrowd012.png" v-show='initData.zn_play_type == 1' height="81" width="76" alt="" />
                </span>
                5副牌
            </label>
            <label :judge='"cardFn7"'>
                <span>
                    <img src="src/srcImg/oxCrowd012.png" v-show='initData.zn_play_type == 2' height="81" width="76" alt="" />
                </span>
                7副牌 
            </label>
        </li>
        <li>
            ...
            <label :judge='"bell"'>
                <span>
                    <img src="src/srcImg/oxCrowd012.png" v-show='initData.zn_pay_type == 1' height="81" width="76" alt="" />
                </span>
                钟点房 
            </label>
            <label :judge='"day"'>
                <span>
                    <img src="src/srcImg/oxCrowd012.png" v-show='initData.zn_pay_type == 2' height="81" width="76" alt="" />
                </span>
                日费房 
            </label>
            <div class="clear"></div>
        ...
        <li>
            ...
            <div class="divTime">
                ...
                <label v-for='times in oxOpen.time' :judge='times' @click='initData.zn_bet_time=times'>
                    <span>
                        <img src="src/srcImg/oxCrowd012.png" v-show='initData.zn_bet_time == times'/>
                    </span>

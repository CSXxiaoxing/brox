      ...
      <mt-popup 
            ...
            <div class='Del_list'>
                <ul>
                    <li v-for='(data, player) in list' :key='data.id' @click='imgStyle.indexOf(player) >= 0 ? imgStyle.splice(imgStyle.indexOf(player),1) : imgStyle.push(player)' v-if='player != "count"'>
                        ...
                        <span>
                        <img v-show="imgStyle.indexOf(player) >= 0" src="src/srcImg/room027.png" />
                        </span>
                    </li>
                </ul>
            </div>
    	...
    	<header>
            <ul>
                ...
                <li>房间成员({{$parent.$parent.lingth}}人)</li>
                <li style="visibility:hidden"><img src="src/srcImg/friend003.png" alt=""></li>
            </ul>
        </header>
        <div class='list'>
            <ul>
                ...
                :class='data.zn_member_id == cli ? "click" : ""' @touchend='cli = data.zn_member_id'>
                    ...
                    <span v-if='$store.state.user.friendId.indexOf(`${data.zn_member_id}`)<0' @click='listAdd(data.zn_member_id)'><img src="src/srcImg/chart_List1.png" alt="">加友</span>
            	</li>

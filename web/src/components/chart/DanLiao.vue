      ...
      v-model="DLRoom" id='DRoom'> 
    	...
    	<header>
            <ul>
                ...
                <li v-show='rank != 1' v-if='$store.state.user.friendId.indexOf(`${sheId}`)<0' @click="findFriend=true"><img src="src/srcImg/qun101.png" alt="">加友</li>
            </ul>
        </header>
        ...
        <footer>
            <div v-if='speak == 0'>
                <img src="src/srcImg/qun004.png" @touchend='speak = 1'>
                <span @touchstart='startRecord' @touchmove='cancelRecord' @touchend='stopRecord'>按住 说话</span>
            </div>
            <div v-if='speak == 1'>
                <img src="src/srcImg/qun003.png" @touchend='speak = 0'>
                <form action="#">
	...
	export default {
        data: function(){
            return {
                ...
                sheName: '???',     // 对方名字
                sheId: 0,           // 对方id
                sheImg: 'src/srcImg/home004.png',         // 对方img

  ...
  <template>
    <mt-popup id='chartRoom' position="top" :modal='false'
      v-model="chatLT" > 
        ...
        <div class='chart'  id='txtbox'>
            <ul>
                ...
                :key = 'data.time' v-if='data.msg != ""'>
                    <img :src="Uid != data.toID ? 'src/srcImg/home004.png' : $store.state.user.userImg">
        ...
        <footer>
        	<div v-if='speak == 0'>
                <img src="src/srcImg/qun004.png" @click='speak = 1'>
                <span @touchstart='startRecord' @touchmove='cancelRecord' @touchend='stopRecord'>按住 说话</span>
            </div>
            <div v-if='speak == 1'>
                <img src="src/srcImg/qun003.png" @click='speak = 0'>
                <form action="#">
